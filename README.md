...
Double-click on "astro_catalog_launcher.bat", accept the Windows prompts, and it will automatically install missing python libraries (if any) and it generates an interactive HTML contact sheet. 
